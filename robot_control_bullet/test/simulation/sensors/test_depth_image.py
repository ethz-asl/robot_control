...
from robot_control_bullet.simulation.sensors import CameraConfig, get_camera_image, depth_buffer_to_depth_image
from robot_control_bullet.simulation import PybulletRobotWrapper
...
class TestDepthImage(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.robot_sim = PybulletRobotWrapper(rca.get_kinova_urdf_path(), [0.0, 0.0, 0.0], fixed_base=True)
...
if __name__ == "__main__":
    import rostest
    rostest.rosrun('robot_control_bullet', 'test_depth_image', TestDepthImage)
